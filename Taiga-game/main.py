...
class Obstacles(pygame.sprite.Sprite):
    ...
    def __init__(self,type):
        ...
        if type == "kaktus":
            self.type = "kaktus"
            self.y_pos = 300
            self.frames = [obstacle_image[type]]
        ...
        if type == "flying_dog":
            ...
            # "flying_dog_1" = pygame.transform.scale(pygame.image.load("Taiga-game/grafiky-taiga/flying_dog.png").convert_alpha(),(90,55.5))
            # "flying_dog_2" = pygame.transform.scale(pygame.image.load("Taiga-game/grafiky-taiga/flying_dog_2.png").convert_alpha(),(90,55.5))
           
           

            self.y_pos = 190
            self.frames = [obstacle_image[type][0],obstacle_image[type][1]]
        ...
        if type == "alien":
            ...
            self.y_pos = 300
            self.frames =[obstacle_image[type][0],obstacle_image[type][1],obstacle_image[type][2]]
        ...
        if type == "taiga-shirt":
            ...
            shirts = [("shirt_green",obstacle_image[type][0]),("shirt_orange",obstacle_image[type][1]),("shirt_brown",obstacle_image[type][2]),("shirt_dark_green",obstacle_image[type][3]),]
        ...
        for obstacle in obstacles:
            if taiga_sprite.fire_can_run != True:
                    ...
                    if obstacle.type != "taiga-shirt":
                        ...
                        if taiga_sprite.headhitbox.colliderect(obstacle.rect) or taiga_sprite.bodyhitbox.colliderect(obstacle.rect):
                            obstacles.empty()
                            return False
                    else:
                        if taiga_sprite.headhitbox.colliderect(obstacle.rect) or taiga_sprite.bodyhitbox.colliderect(obstacle.rect):
                ...
                if taiga_sprite.bodyhitbox.colliderect(obstacle.rect) or taiga_sprite.headhitbox.colliderect(obstacle.rect):
                    obstacle.kill()
...
obstacle_image = {"kaktus": pygame.transform.scale(pygame.image.load("Taiga-game\grafiky-taiga\kaktus_normalny.png").convert_alpha(),(57.4,93.8)),
                "maly_kaktus": pygame.transform.scale(pygame.image.load("Taiga-game\grafiky-taiga\maly_kaktus_normalny.png").convert_alpha(),(44.2,47.6)),
                "kaktus_bodky":pygame.transform.scale(pygame.image.load("Taiga-game\grafiky-taiga\kaktus_bodky.png").convert_alpha(),(57.4,93.8)),
                "maly_kaktus_bodky": pygame.transform.scale(pygame.image.load("Taiga-game\grafiky-taiga\maly_kaktus_bodky.png").convert_alpha(),(44.2,47.6)),
                "flying_dog" : [pygame.transform.scale(pygame.image.load("Taiga-game/grafiky-taiga/flying_dog.png").convert_alpha(),(90,55.5)),
                pygame.transform.scale(pygame.image.load("Taiga-game/grafiky-taiga/flying_dog_2.png").convert_alpha(),(90,55.5))],
                "flying_dog_lower": [pygame.transform.scale(pygame.image.load("Taiga-game/grafiky-taiga/flying_dog.png").convert_alpha(),(90,55.5)),
                pygame.transform.scale(pygame.image.load("Taiga-game/grafiky-taiga/flying_dog_2.png").convert_alpha(),(90,55.5))],
                "double_small_cactus" : pygame.transform.scale(pygame.image.load("Taiga-game\grafiky-taiga\double_maly_kaktus.png"),(90,47.6)),
                "triple_small_cactus" : pygame.transform.scale(pygame.image.load("Taiga-game\grafiky-taiga/triple_maly_kaktus.png").convert_alpha(),(145,47.6)),
                 "double_big_kaktus" : pygame.transform.scale(pygame.image.load("Taiga-game\grafiky-taiga\double_big_kaktus.png").convert_alpha(),(125,93.8)),
                "taiga_cow" : [pygame.transform.scale(pygame.image.load("Taiga-game/grafiky-taiga/taiga-cow-1.png").convert_alpha(),
                (130,110)),pygame.transform.scale(pygame.image.load("Taiga-game\grafiky-taiga/taiga-cow-2.png").convert_alpha(),(130,110))],
                "taiga_cow_lower" : [pygame.transform.scale(pygame.image.load("Taiga-game/grafiky-taiga/taiga-cow-1.png").convert_alpha(),
                (130,110)),pygame.transform.scale(pygame.image.load("Taiga-game\grafiky-taiga/taiga-cow-2.png").convert_alpha(),(130,110))],
                "triple_big_kaktus" : pygame.transform.scale(pygame.image.load("Taiga-game\grafiky-taiga/triple_big_kaktus.png").convert_alpha(),(180,93.8)),
                "alien" : [pygame.transform.scale(pygame.image.load("Taiga-game\grafiky-taiga/alien_blue.png").convert_alpha(),(100,100)),
                           pygame.transform.scale(pygame.image.load("Taiga-game\grafiky-taiga/alien_orange.png").convert_alpha(),(100,100)),
                           pygame.transform.scale(pygame.image.load("Taiga-game\grafiky-taiga/alien_red.png").convert_alpha(),(100,100))],
                "wall" : pygame.transform.scale(pygame.image.load("Taiga-game\grafiky-taiga/taiga-wall.png").convert_alpha(),(65,135)),
                "taiga-shirt": [pygame.transform.scale(pygame.image.load("Taiga-game\grafiky-taiga/taiga-shirts-1.png").convert_alpha(),(100,105)),
                pygame.transform.scale(pygame.image.load("Taiga-game\grafiky-taiga/taiga-shirts-2.png").convert_alpha(),(100,105)),
                pygame.transform.scale(pygame.image.load("Taiga-game\grafiky-taiga/taiga-shirts-3.png").convert_alpha(),(100,105)),
                pygame.transform.scale(pygame.image.load("Taiga-game\grafiky-taiga/taiga-shirts-4.png").convert_alpha(),(100,105))],
                "4_kaktusy" : pygame.transform.scale(pygame.image.load("Taiga-game\grafiky-taiga/4_kaktusy.png").convert_alpha(),(260,106))}
#timers
...
score_displaying_timer = pygame.USEREVENT + 4
pygame.time.set_timer(score_displaying_timer,100)

variables_update_timer = pygame.USEREVENT + 5
pygame.time.set_timer(variables_update_timer,1000)
...
font = pygame.font.Font("Taiga-game/Pixeltype.ttf",50)
font_big = pygame.font.Font("Taiga-game/Pixeltype.ttf",85)
font_fire_napis = pygame.font.Font("Taiga-game/Pixeltype.ttf",300)
#texty
...
fire_napis_time = 0
you_died_print_once_variable = 0
fps_wait = 0
...
while True:
        ...
        if game_active == True:
            ...
            if event.type == obstacle_unpause_fix_timer:
                ...
                if cislo > time_to_wait:
                    obstacle_can_run = True
            if event.type == variables_update_timer:
                if score < 1300  :
                    cas_obstacle_timer_speed_up_var+=0.018
                
                else:
                    cas_obstacle_timer_speed_up_var+=1.8
                    cislo = 0
                if score < 1300:
                    obstacle_speed_up_var+=0.04
                    index_speed_var+=0.0005
                else:
                    obstacle_speed_up_var+= 0.03
                    index_speed_var+= 0.0003

            if event.type == score_displaying_timer:
                current_time = int(pygame.time.get_ticks() / 100) - start_time - pause_time
                score_surf = font.render(f'Your score is: {current_time}',False,(1,1,1)).convert_alpha()
                score_rect = score_surf.get_rect(center = (500,30))
                score = current_time
    ...
    #death
        ...
        if you_died_text_index > 11:
            ...
            you_died_print_once_variable+=1
    
            if you_died_print_once_variable ==1: 
